# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2019-09-03 10:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveIntegerField(choices=[(1, '可用'), (0, '删除')], default=1, verbose_name='状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(help_text='注：目前只支持markdown数据', verbose_name='内容')),
                ('content_html', models.TextField(blank=True, editable=False, verbose_name='正文html代码')),
                ('status', models.IntegerField(choices=[(1, '上线'), (2, '草稿'), (0, '删除')], default=1, verbose_name='状态')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
